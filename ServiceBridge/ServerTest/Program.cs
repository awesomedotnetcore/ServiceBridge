    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                reg = new ServiceBridge.distributed.zookeeper.ServiceManager.ServiceRegister("es.qipeilong.net:2181", () => ServiceBridge.rpc.ServiceHostManager.Host.GetContractInfo().Select(x => new ServiceBridge.distributed.zookeeper.ServiceManager.ContractModel(x.contract, x.url)).ToList());
